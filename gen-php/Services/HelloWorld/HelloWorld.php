...
class HelloWorldClient implements \Services\HelloWorld\HelloWorldIf {
  ...
  {
    $args = new \Services\HelloWorld\HelloWorld_ping_args();
  ...
  public function recv_ping()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Services\HelloWorld\HelloWorld_ping_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Services\HelloWorld\HelloWorld_ping_result();
  ...
  {
    $args = new \Services\HelloWorld\HelloWorld_hello_args();
    $args->name = $name;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\Services\HelloWorld\HelloWorld_hello_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \Services\HelloWorld\HelloWorld_hello_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
...
class HelloWorld_hello_args {
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('HelloWorld_hello_args');
    if ($this->name !== null) {
...
class HelloWorld_hello_result {
  ...
  public function getName() {
    return 'HelloWorld_hello_result';
  }
  ...
  public function write($output) {
    $xfer = 0;
    $xfer += $output->writeStructBegin('HelloWorld_hello_result');
    if ($this->success !== null) {
      $xfer += $output->writeFieldBegin('success', TType::STRING, 0);
      $xfer += $output->writeString($this->success);
      $xfer += $output->writeFieldEnd();
...
class HelloWorldProcessor {
  ...
  protected function process_hello($seqid, $input, $output) {
    ...
    $input->readMessageEnd();
    $result = new \Services\HelloWorld\HelloWorld_hello_result();
    $result->success = $this->handler_->hello($args->name);
    $bin_accel = ($output instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
